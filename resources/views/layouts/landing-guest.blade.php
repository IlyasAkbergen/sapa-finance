    ...
    <footer id="footer">
        <div class="footer__inner">
            ...
            <div>
                ...
                <ul class="menu-vertical">
                    <li>
                        <a href="{{ asset('Политика_конфиденциальности.docx') }}"
                           download>
                            Политика конфиденциальности
                        </a>
                    </li>
                    <li>
                        <a href="{{asset('Договор_оферты.docx')}}"
                           download>
                            Публичная оферта
                        </a>
                    </li>
                    <li>
                        <a href="{{ asset('test.txt') }}"
                           download>
        ...
        <div class="modal-dialog modal-dialog-consultant">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex">
                        <div>
                            <img src="http://127.0.0.1:8000/images/slides/consultants-consultants-slider-img4.png"
                                 alt="">
                        </div>
                        <div>
                            <h3>Брасилова Акжунис</h3>
                            <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde, dignissimos magnam harum!
                                Molestias, ut. Ipsam accusantium ut tenetur veritatis, mollitia eaque aperiam, labore,
                                aliquid architecto enim dolor amet. Obcaecati sequi saepe ut maxime non officiis
                                incidunt consequatur iure molestias inventore?
                            </p>
                            <p>
                                Lorem, ipsum dolor sit amet consectetur adipisicing, elit. Voluptates, modi perspiciatis
                                corporis reprehenderit libero, vero debitis ipsum, eius beatae architecto accusantium
                                sequi veniam deleniti voluptatem nemo rem, nisi ipsa distinctio!
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-lg scrollable news">
            ...
            <div class="modal-content">
                ...
                <div>
                    ...
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing, elit. Hic, itaque et voluptas est autem
                        deserunt labore dolore sequi pariatur quo, rem, magni. Eos, incidunt sequi nemo ullam minima
                        molestiae id, eius illum quaerat esse. Facilis omnis harum perferendis quidem ab.
                    </p>
                </div>
            </div>
        </div>
