    ...
    <main-layout>
        ...
        <div class="page__consultant-settings-program-modal-2" v-show="showAboutPointsModal">
            ...
            <div class="page__program-modal__body">
                ...
                <p class="page__program-modal__body__text">
                    <b>Командные единицы это:</b> Lorem Ipsum is simply dummy text of the printing and typesetting
                    industry.
                </p>
                <p class="page__program-modal__body__text">
                ...
                <p class="page__program-modal__body__text">
                    ФК вправе продавать и зарабатывать комиссионные вознаграждение от продажи образовательных продуктов
