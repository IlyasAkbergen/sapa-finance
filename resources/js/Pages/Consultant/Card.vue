...
<script>
    export default {
        ...
        computed: {
            avatarPath() {
                return this.consultant.profile_photo_path
                    ? this.consultant.profile_photo_path
