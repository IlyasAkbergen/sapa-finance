  ...
  <div class="table-responsive">
    <table class="table">
      ...
      <tr>
        ...
        <td class="float-right" v-if="homework.status === 2">
          <a class="osk__status osk__status--red">Отказано</a>
        </td>

        <td class="float-right" v-if="homework.status === 1">
          <a class="osk__status osk__status--sky">Принято</a>
        </td>
      </tr>
<!--      <tr v-for="attachment in homework.attachments">-->
<!--        <td class="align-middle">-->
